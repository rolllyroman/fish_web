...
MENU_NOTIC_LIST_TXT = '公告列表'
MENU_ACTIVE_LIST_TXT = '活动列表'
MENU_NOTIC_MAIL_LIST_TXT = '邮件列表'
MENU_BENEFIT_TXT = '福利系统'
MENU_BENEFIT_SIGN_TITLE = '签到管理'
MENU_BENEFIT_SAVE_TITLE = '救济金设置'

MENU_GOODS_TXT = '商品管理'
MENU_GOODS_LIST_TXT = '商品列表'
MENU_GOODS_REWARD_LIST_TXT = '兑换奖品管理'
MENU_GOODS_EXCHANGE_LIST_TXT = '奖品兑换记录'
MENU_GOODS_CURRENCY_EXCHANGE_LIST_TXT = '道具兑换列表'
MENU_AGENT_TXT = '公会代理管理'
...
MENU_FISH_TXT = '捕鱼游戏'
MENU_FISH_CHARGE_AND_ORDERS = '订单与充值'
MENU_FISH_ITEM_LIST_TXT = '捕鱼道具列表'
MENU_FISH_DATA_TXT = '捕鱼游戏数据'
MENU_FISH_ROOM_LIST_TXT = '捕鱼房间列表'
MENU_FISH_STATIS_TXT = '总玩入玩出统计'
MENU_FISH_PROPS_TXT = '捕鱼金币弹头统计'
MENU_FISH_GUILD_LIST = '捕鱼公会列表'
MENU_FISH_SEND_MAIL_TXT = '捕鱼发送系统邮件'
...
MENU_FISH_SETTING_LEVEL_TXT = '捕鱼参数设置'
...
GAME_ACTIVE_DEL_SUCCESS_TXT = '删除活动成功'
...
BENEFIT_SIGN_LIST_TXT = "签到配置列表"
BENEFIT_SIGN_ADD_TXT  = "创建签到规则"
BENEFIT_SIGN_SETTING_TXT  = "签到规则设置"
BENEFIT_SIGN_CREATE_SUCCESS_TXT  = "创建签到规则[%s]%s"
BENEFIT_SIGN_EDIT_SUCCESS_TXT    = "编辑签到规则[%s]%s"
BENEFIT_SIGN_DELETE_SUCCESS_TXT    = "删除签到规则[%s]%s"
BENEFIT_SIGN_OPEN_SUCCESS_TXT    = "开启签到规则[%s]%s"

BENEFIT_SAVE_TXT = '救济金配置'
BENEFIT_TAKE_TIME_TXT = "允许每日领取次数"
BENEFIT_TAKE_COIN_TXT = "每日领取金额"
BENEFIT_SAVE_MIN_COIN_TXT = "用户金额下限(低于此金额可领取)"

...
大厅活动列表
"""
FORMAT_GAMEHALL_ACTIVE_LIST_TABLE = "actives:list"
FORMAT_FISHHALL_ACTIVE_LIST_TABLE = "actives:list:fish"
FORMAT_ACTIVE_COUNT_TABLE = "actives:count"
...
FORMAT_GAMEHALL_ACTIVE_TABEL = "actives:%s"

"""
玩家信息已读列表
"""
FORMAT_MSG_READ_SET = "notices:%s:read:set"
FORMAT_ACT_READ_SET = "actives:%s:read:set"

"""
管理员发送公告列表
"""
FORMAT_MGR_SEND_MESSAGE_LIST = "agent:%s:send:message:list"
FORMAT_ACTIVE_SEND_MESSAGE_LIST = "agent:active:%s:send:list"
...
玩家活动box表
"""
FORMAT_USER_ACTIVE_LIST = "user:%s:actives:list"
FORMAT_USER_ACTIVE_FISH_LIST = "user:%s:fish:actives:list"
...
FISH_FIRST_SHARE_PER_DAY_SET = "fish:first:share:%s:sets"
'''
待领取金币的玩家ID集合
'''
...
已领取金币的玩家ID集合
'''
FISH_SHARE_TAKE_SETS = "fish:share:take:%s:sets"
'''
捕鱼配置表
{
        share_coin  :   每日分享获得金币
...
TMP_FORMAT_USER_COIN_TABLE = "users:coinTmp:zset"
...
救济金领取
救济金领取集合表
benefit:coin:take:hesh
"""
# FISH_BENEFIT_COIN_TABLE = "benefit:coin:take:hesh"
FISH_BENEFIT_COIN_TABLE = "benefit:coin:take:%s:hesh"
...
benefit:coin:conf
"""
FISH_BENEFIT_COIN_CONF = "benefit:coin:conf"
"""
救济金共享token
"""
USER_BENEFIT_TOKEN = "benefit:user:%s:token"

"""
签到表
sign:$id:table
{
    1:  {'taked':[],image:'','name':'',type:'','coin':''},
    2:  {'taked':[],image:'','name':'',type:'','coin':''},
    3:  {'taked':[],image:'','name':'',type:'','coin':''},
    4:  {'taked':[],image:'','name':'',type:'','coin':''},
    5:  {'taked':[],image:'','name':'',type:'','coin':''},
    6:  {'taked':[],image:'','name':'',type:'','coin':''},
    7:  {'taked':[],image:'','name':'',type:'','coin':''}
}
"""
FISH_TABLE_NOW_RUN = "sign:now:run"

FISH_SIGN_TABLE = "sign:fish:%s:table"

FISH_SIGN_TABLE_WEEK = "sign:fish:%s:%s:hesh"

FISH_SIGN_TABLE_USER_NUMBER = "sign:fish:user:numbers:%s:hesh"

FISH_SIGN_TABLE_USER_RECEIVE = "sign:fish:user:numbers:%s:receive:hesh"
"""
签到奖励规则列表
"""
FISH_SIGN_ID_COUNT = "sign:table:count"
FISH_SIGN_TABLE_LIST ="sign:list:fish:table"


"""
活动日期
一帆风顺 {'from': '2018-2-7', 'to': '2018-2-22'}
"""
...
question    = 题目
answer      = 答案列表 array
formType    = 表单类型 ： 1单选  2多选
correct     = 正确答案序号，多个用","分隔


"""
ACTIVICE_QUESTION_SELECT = 4    #选择多少题
ACTIVICE_QUESTION_TIME = 7      #答题间隔
ACTIVICE_QUESTION_TITLE = '超级问答'
ACTIVICE_QUESTION_DESC = '超级问答,一共四道题，每答对一题可获取一个红包，每天每个用户只能参与一次。'
"""
...
"""
答题完毕玩家的集合
activice:question:answer:hesh
"""
ACTIVICE_QUESTION_ANSWER = 'activice:question:answer:hesh'
# 已经点了开始的玩家的集合
...
SURVER_SEND_GOLD = 500000
ACTIVICE_SURVER_TITLE = '捕鱼问卷调查'
ACTIVICE_SURVER_DESC = '为了感谢您对我们完善游戏的帮助，我们将在您完成问卷后赠送50万金币。'

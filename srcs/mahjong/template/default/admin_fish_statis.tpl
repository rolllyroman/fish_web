  <div class='block'>
       ...
       <div class='content'>
          <div id="toolbar" class="btn-group">
               ...
               <button id="btn_add" type="button" class="btn btn-sm btn-primary">
                  <span class="glyphicon glyphicon-plus">
                      <a href="/admin/fish/statis/test" style='color:#FFF;text-decoration:none;'>新手场玩入玩出统计</a>
                  </span>
              </button>
    ...
    */
    ...
    $('#loadDataTable').bootstrapTable({
		...
		function getOp(value,row,index){
          ...
          res = "<a href='/admin/fish/clear/statis?uid="+rowobj['uid']+"' class='btn btn-primary'>清零玩入玩出数据</a>"

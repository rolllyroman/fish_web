...
<script type="text/javascript">
    $(function(){
        ...
        if( /micromessenger/.test(agent) || /qq\//.test(agent) || (/iphone|ipad|ipod/.test(agent) && /micromessenger/.test(agent))){
               ...
               var res_ios = "url('/assest/default/image/invite/invite_bg_resios.png') no-repeat";
               var res_android = "url('/assest/default/image/invite/invite_bg_resandroid.png') no-repeat";
               
               var res = /iphone|ipad|ipod/.test(agent) ? res_ios : res_android;
               $('#layertip').css({
                       'background': res,

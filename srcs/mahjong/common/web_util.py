...
def get_redis(dbNum):
    global redisdb
    redisdb = redis.ConnectionPool(host=conf.get('redis.host'), port=conf.get('redis.port'), db=conf.get('redis.database'), password='Fkkg65NbRwQOnq01OGMPy5ZREsNUeURm')
...
def get_form(args_name, msg, is_strip=True, lenght=0, is_check_null=True, notify_msg='', is_check_special_char=False):
    """
    获取客户端Form方式提交的参数值
    :param args_name: 参数名
    :param msg: 参数中文名称

...
@admin_app.get('/agent/info/<agent_id:int>')
...
@admin_app.get('/agent/create/<agent_id:int>')
...
@admin_app.post('/agent/create/<agent_id:int>')
...
@admin_app.get('/agent/modify/<agent_id:int>')
